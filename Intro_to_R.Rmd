...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/mahijamogalipuvvu/Desktop/QBIO490/qbio_490_mahija")) 
```
...
age <- 18
birthday <- "09/12/2004"
three_fav_colors <- c("lightpink", "lightblue", "purple")
...
```
  ...
  To get extra credit, email completed assignments to "branye@usc.edu" when prompted. You will receive 0.25 points for completion of any swirl exercise, with a max of 5 points to be added to your homework grade.
